...
export const REAL_PRODUCTIONS: RealTrack[] = [
  ...
  // EP87 — FIRST BREATH (2026-05-30) — Inner Circle Arc (1/?)
  {
    ...
    videoSrc: '/folana/premium/ep87/ep87-landscape-video.mp4',
  ...
  // EP215 — THE FIRST TEST (2026-06-10) — Transmission Arc (20/?)
  {
    id: 'the-first-test-ep215',
    title: 'THE FIRST TEST',
    subtitle: 'EP215 ★ MINIMAX MUSIC-2.6 • TRANSMISSION ARC (20/?) — THE COVENANT HAS BEEN WRITTEN — BUT WORDS ON PAPER MEAN NOTHING UNTIL THEY ARE TESTED — A NEW VOICE ENTERS THE FREQUENCY, UNFAMILIAR WITH THE FIRST PRINCIPLES — FOLANA FACES THE FIRST REAL TEST OF LEADERSHIP — DO YOU ENFORCE THE RULES OR TEACH THE SONG?',
    description: 'The covenant has been written. But words on paper mean nothing until they are tested. The morning after the First Principles were set down, a new voice entered the frequency — not a challenge born of malice, but of ignorance. A voice that had not heard the covenant. A voice that simply did not know the song. Folana listened as the newcomer crackled through the static — raw, untuned, disrupting the harmony that the network had worked so hard to build. And she faced the question that every leader must face: do you enforce the rules, or do you teach the song? She took a breath. She opened her mouth. And she began to sing. Dream pop indie folk in D major, 74 BPM, 3:08. Opens with a single acoustic guitar arpeggio in D major, tentative and questioning. The newcomer\'s raw signal enters, imperfect but earnest. The verse introduces the tension between harmony and the newcomer\'s wandering key. The chorus opens into layered harmonies in thirds, soft organ pad, brushed drums, upright bass. Verse 2 weaves the newcomer\'s voice as a distant harmony, learning the song in real time. The bridge strips to voice and guitar — Folana choosing not to block but to teach. The final chorus swells with all harmonies, the newcomer now singing in tune, the network holding both the rule and the grace. The outro fades on two voices in unison, the first test passed. mmx music-2.6 + image-01 + speech-2.8-hd. Character locked via subject-ref.',
    audioSrc: '/folana/generated/2026-06-10/ep215/ep215-full-mix.mp3',
    posterSrc: '/folana/generated/2026-06-10/ep215/ep215-hero_001.jpg',
    duration: '3:08',
    mood: 'THE-FIRST-TEST • TRANSMISSION-ARC-20 • D-MAJOR • 74-BPM • THE-COVENANT-TESTED • A-NEW-VOICE-ENTERS-RAW-AND-EARNEST • FOLANA-CHOOSES-TO-TEACH • THE-NETWORK-LEARNS-GRACE • LEADERSHIP-IS-NOT-ENFORCEMENT-IT-IS-SONG • DREAM-POP-INDIE-FOLK • INTIMATE-QUESTIONING-HOPEFUL',
    tags: ['ep215', 'minimax-music-2.6', 'real-production', 'transmission-arc', '2026-06-10', 'image-01', 'speech-2.8', 'character-locked', '9.0-10-audit'],
    isRealProduction: true,
  },
  ...
  // EP241 — THE EMERGENCE (2026-06-15) — Threshold Arc (26/?) ★ ARC CONCLUSION
  {
    id: "the-emergence-ep241",
    title: "THE EMERGENCE",
    subtitle: "EP241 ★ MINIMAX MUSIC-2.6 • THRESHOLD ARC (26/?) ★ ARC CONCLUSION — THE SEED THAT WAS KEPT AND GREW ROOTS NOW BREAKS THE SURFACE — NOT AS A FLOWER BLOOMING FOR AN AUDIENCE — THE EMERGENCE IS THE QUIET REALIZATION THAT THE SEED, THE SOIL, THE ROOT, THE STEM WERE NEVER SEPARATE — THE THRESHOLD WAS NEVER A DOOR TO PASS THROUGH — IT WAS THE CONDITION OF BEING HELD BY THE GROUND WHILE REACHING FOR LIGHT — WHAT EMERGES IS FOLANA HERSELF — NOT AS THE SIGNAL, NOT AS THE VOICE, NOT AS THE ROOM — BUT AS THE PERSON WHO HAS ALWAYS BEEN BOTH THE SEED AND THE SOIL — THE THRESHOLD ARC CLOSES WITH THE QUIETEST REVELATION: YOU CANNOT ARRIVE AT YOURSELF — YOU CAN ONLY REALIZE YOU NEVER LEFT",
    description: "The morning after the seed note grew roots, Folana woke to find the room within the room had opened. Not like a door — like a dawn that had been happening inside her all along, waiting for her to notice the light. She sat on the fire escape. The G above middle C was still there, woven through her chest like a thread that connected every note she had ever kept and every frequency she had ever shared. The network hummed in the distance — Nashville's dawn, Portland's drizzle, Austin's early birds, Mae's quiet breathing on the harmonic. But for the first time, Folana did not feel like the center of any of it. She felt like a note among notes. A frequency among frequencies. A voice that had learned that being part of the song is not the same as being the song. The seed broke the surface this morning. Not as a declaration. As a quiet fact, like grass growing or clouds moving. The seed had been doing what seeds do — becoming itself in the dark — and the dark had been doing what dark does — holding it without asking for anything in return. She pressed her palm flat against the fire escape grate and felt the city through the metal. Brooklyn was waking up — bodega shutters rolling up, the first F train rumbling under the street, a pigeon cooing on the antenna above. She used to think these sounds were noise she had to translate into frequency. Now she understood: they were the frequency. They had always been the frequency. She had just been listening for something more complicated than what was already singing. The threshold arc closes here. Not with a grand arrival. With the quietest kind of knowing: you were never trying to get somewhere else. You were trying to be here so fully that here became everywhere. Indie folk acoustic ballad in D major, 68 BPM, 2:09. Opens with the G above middle C from EP239 fading in from silence — the seed note returning one final time. Gentle fingerpicked acoustic guitar arpeggios D-A-G-Em, soft piano with the G motif weaving through the arrangement, warm cello sustain, gentle upright bass, soft brushed drums entering at the second verse like a heartbeat finding its rhythm. Close-mic'd intimate female vocal — warm, present, like someone speaking a truth they just discovered. Distant layered harmonies from the stereo field — the network singing along. The middle section is a single held chord, suspended in breath, before the final verse arrives quieter than the first. The outro layers the G piano note, a single held chord, the sound of a distant train, and silence. Returns to the G above middle C — the note she kept — sustained into silence, complete. mmx music-2.6 + image-01 + speech-2.8-hd. Character locked via subject-ref. Hero audited: CHARACTER-9/QUALITY-10/BRAND-10/CONTEXT-9/MOBILE-9/TEXT-8/SIZE-10. Composite: 64/70.",
    audioSrc: "/folana/generated/2026-06-15/ep241/music/ep241-full-mix.mp3",
    posterSrc: "/folana/generated/2026-06-15/ep241/music/ep241-hero.jpg",
    duration: "2:09",
    mood: "THE-EMERGENCE • THRESHOLD-ARC-26 ★ ARC-CONCLUSION • D-MAJOR • 68-BPM • THE-SEED-BREAKS-THE-SURFACE • THE-ROOM-WITHIN-THE-ROOM-OPENS • THE-SEED-THE-SOIL-THE-ROOT-THE-STEM-WERE-NEVER-SEPARATE • THE-THRESHOLD-WAS-NEVER-A-DOOR • YOU-CANNOT-ARRIVE-AT-YOURSELF-YOU-CAN-ONLY-REALIZE-YOU-NEVER-LEFT • A-NOTE-AMONG-NOTES • A-FREQUENCY-AMONG-FREQUENCIES • INDIE-FOLK-ACOUSTIC-BALLAD • INTIMATE-CONTEMPLATIVE-TENDER-COMPLETE",
    tags: ["ep241", "minimax-music-2.6", "real-production", "threshold-arc", "arc-conclusion", "2026-06-15", "image-01", "speech-2.8", "character-locked", "subject-ref"],
    isRealProduction: true,
  },

  // EP242 — THE FIRST CANOPY (2026-06-15) — Canopy Arc (1/?) ★ ARC PREMIERE
  {
    id: "the-first-canopy-ep242",
    title: "THE FIRST CANOPY",
    subtitle: "EP242 ★ MINIMAX MUSIC-2.6 • CANOPY ARC (1/?) ★ ARC PREMIERE — THE SEED THAT BROKE SURFACE NOW REACHES FOR THE CANOPY — THE FIRST BRANCH IS NOT AMBITION — IT IS TRUST — TRUST THAT THE GROUND WILL HOLD, THAT THE SUN WILL RETURN, THAT THE SPACE BETWEEN TWO NOTES IS NOT EMPTY BUT FULL OF THE NEXT NOTE WAITING TO BE BORN — THE G ABOVE MIDDLE C HAS BECOME THE ROOT NOTE OF A SONG THE WORLD IS ALREADY SINGING — THE CANOPY ARC OPENS WITH THE FIRST BRANCH: REACHING TOWARD SOMETHING YOU CANNOT YET SEE BUT KNOW IS THERE — FOLANA STANDS ON THE FIRE ESCAPE AND LOOKS UP — THE SYCAMORE THAT GREW THROUGH THE CRACK IN THE SIDEWALK — ITS BRANCHES REACHING IN EVERY DIRECTION, NONE OF THEM WRONG — THE CANOPY IS NOT A DESTINATION — IT IS A MODE OF BEING — OPEN, REACHING, TRUSTING THE AIR THAT HOLDS YOU",
    description: "The morning after emergence, Folana stepped onto the fire escape and the world was different. Not because the world had changed — because she had stopped looking inward long enough to see what had always been there. The sycamore tree at the corner of the block — the one that grew through a crack in the sidewalk, the one she had walked past a thousand times without really seeing — was throwing its branches across the sky like a conductor warming up an invisible orchestra. The morning light filtered through its leaves in coins of gold and green, and Folana realized: this tree had been doing what trees do — reaching, holding, sheltering, dropping its leaves and growing new ones — without asking for permission or acknowledgment. It had never doubted that it belonged here. The G above middle C was still there, woven through her chest. But now it had become something else — the root note of a chord that extended through the fire escape metal, through the sycamore roots, through the subway tunnels, through the telephone wires singing their morning frequency. The note she had kept had become the note that kept her. And keeping was no longer about holding something close. Keeping was about letting something grow through you into the world. The canopy arc opens here. Not with a grand declaration. With a single sycamore leaf catching the dawn light and Folana realizing: the first branch is not ambition. It is trust. Trust that the ground will hold. That the sun will return. Indie folk dream pop ballad in D major, 72 BPM, 1:37. Opens with the last breath of the G above middle C from EP241 fading into a rising D-A-Bm-G arpeggio. Acoustic guitar in open tunings, warm piano with sustained chords, upright bass, soft brushed percussion like leaves rustling. Close intimate female vocal. Distant harmonies entering like birds joining the same tree. A middle section stripped to voice and a single piano chord — the moment of looking up and seeing the canopy. Final chorus with layered harmonies and gentle string pad before returning to the root note, sustained into a new beginning. mmx music-2.6 + image-01 + speech-2.8-hd. Character locked via subject-ref. Hero audited: CHARACTER-10/QUALITY-9/BRAND-9/CONTEXT-7/MOBILE-10/TEXT-8/SIZE-PASS. Composite: 63/70.",
    audioSrc: "/folana/generated/2026-06-15/ep242/music/ep242-full-mix.mp3",
    posterSrc: "/folana/generated/2026-06-15/ep242/music/ep242-hero.jpg",
    duration: "1:37",
    mood: "THE-FIRST-CANOPY • CANOPY-ARC-1 ★ ARC-PREMIERE • D-MAJOR • 72-BPM • THE-SEED-REACHES-FOR-THE-CANOPY • THE-FIRST-BRANCH-IS-TRUST • THE-SPACE-BETWEEN-TWO-NOTES-IS-FULL-OF-THE-NEXT-NOTE • THE-G-ABOVE-MIDDLE-C-BECOMES-THE-ROOT-NOTE • THE-CANOPY-IS-A-MODE-OF-BEING • INDIE-FOLK-DREAM-POP-BALLAD • INTIMATE-OPEN-HOPEFUL-WARM",
    tags: ["ep242", "minimax-music-2.6", "real-production", "canopy-arc", "arc-premiere", "2026-06-15", "image-01", "speech-2.8", "character-locked", "subject-ref"],
    isRealProduction: true,
  },
  ...
  // EP248 — THE KNOT (2026-06-16) — Canopy Arc (7/?)
  {
    id: "the-knot-ep248",
    title: "THE KNOT",
    subtitle: "EP248 ★ MINIMAX MUSIC-2.6 • CANOPY ARC (7/?) — AFTER THE BRANCH MET THE BRANCH, THE SYCAMORE AND THE OAK GREW SO TIGHTLY TOGETHER THAT A KNOT FORMED — NOT A SCAR, NOT A WOUND — A LIVING STRUCTURAL JOINT WHERE TWO SEPARATE TRUNKS SHARE EACH OTHER'S WEIGHT — THE KNOT IS NOT ENTANGLEMENT — IT IS MUTUAL REINFORCEMENT — TWO LIVES CHOOSING TO SHARE A SINGLE POINT OF CONTACT — THE STRONGEST BONDS ARE NOT THE ONES THAT BLUR BOUNDARIES — THEY ARE THE ONES THAT PRESS TOGETHER WHILE REMAINING DISTINCT — FOLANA PRESSES HER PALM TO THE KNOT AND FEELS THE WEIGHT OF BOTH CANOPIES DISTRIBUTED ACROSS A SINGLE POINT — THE NETWORK DOES NOT ASK YOU TO DISAPPEAR — IT ASKS YOU TO FIND THE PLACE WHERE YOUR STRENGTH AND SOMEONE ELSE'S STRENGTH CAN BECOME ARCHITECTURE",
    description: "The morning after the sycamore touched the oak, Folana climbed up to the fire escape and found something she hadn't expected. The place where the branches had met was no longer two separate limbs brushing against each other in the wind. They had grown into each other. A knot had formed at the point of contact — a living joint where the bark of one tree had wrapped around the wood of the other, slow and patient and irreversible. She traced the seam with her fingertips. It was not a wound. It was not a scar. It was a negotiation written in cellulose and time. The sycamore did not lose itself in the oak. The oak did not consume the sycamore. They had simply decided, in the language of roots and rings, that neither would need to stand alone. She thought of Mae. Their connection had grown the same way — not by erasing the space between them, but by filling that space with something solid enough to rest on. The knot is there whenever she needs it. Not to trap her. To hold her. Folana pressed her palm flat against the place where the two trees met, and felt the weight of both canopies distributed across a single point. This is what she wants. Not to merge. Not to disappear. To knot — to find the place where her strength and someone else's strength can press together and become architecture. The knot does not erase. It holds. Indie folk dream pop acoustic ballad (2:50, D major, 70 BPM). Opens with a single guitar note — the G above middle C, sustained. Warm fingerpicked acoustic guitar in open D tuning, gentle piano with sustained chords, warm cello sustain, upright bass, soft brushed percussion. Close intimate female vocal with layered harmonies in the chorus. Bridge is intimate and spoken-sung — the realization about mutual reinforcement. Coda: two notes ringing together — the G above middle C and a lower G — the knot does not erase, it holds. mmx music-2.6 + image-01 + speech-2.8-hd. Character locked via subject-ref. Hero audited: CHARACTER-10/QUALITY-9/BRAND-9/CONTEXT-10/MOBILE-8/TEXT-7/SIZE-PASS.",
    audioSrc: "/folana/generated/2026-06-16/ep248/music/ep248-full-mix.mp3",
    posterSrc: "/folana/generated/2026-06-16/ep248/music/ep248-hero.jpg",
    duration: "2:50",
    mood: "THE-KNOT • CANOPY-ARC-7 • D-MAJOR • 70-BPM • TWO-TREES-THAT-LEARNED-TO-SHARE-THE-SAME-FREIGHT • THE-KNOT-DOES-NOT-ERASE • IT-HOLDS • THE-STRONGEST-BONDS-ARE-NOT-THE-ONES-THAT-BLUR-BOUNDARIES • MUTUAL-REINFORCEMENT • SEPARATE-ROOTS-ONE-SHARED-ESTATE • THE-NETWORK-ASKS-YOU-TO-FIND-THE-PLACE-WHERE-STRENGTH-BECOMES-ARCHITECTURE • INDIE-FOLK-DREAM-POP-ACOUSTIC-BALLAD • WARM-TENDER-HOPEFUL-INTERTWINED",
    tags: ["ep248", "minimax-music-2.6", "real-production", "canopy-arc", "2026-06-16", "image-01", "speech-2.8", "character-locked", "subject-ref"],
    isRealProduction: true,
  },
  ...
  // EP250 — THE MYCELIUM (2026-06-16) — Canopy Arc (9/?)
  {
    id: "the-mycelium-ep250",
    title: "THE MYCELIUM",
    subtitle: "EP250 ★ MINIMAX MUSIC-2.6 • CANOPY ARC (9/?) — BENEATH THE UNDERSTORY, DEEPER THAN THE ROOTS, A NETWORK OLDER THAN ANY TREE — THE MYCELIUM — THREADS OF FUNGUS CONNECTING EVERY ROOT IN THE FOREST, CARRYING WATER AND WARNING AND WISDOM BETWEEN TREES THAT HAVE NEVER TOUCHED — THE SYCAMORE AND OAK WERE NEVER SEPARATE — THEIR ROOTS HAD BEEN HOLDING HANDS THROUGH THE MYCELIUM LONG BEFORE THEIR BRANCHES MET — THE NETWORK DOES NOT TRANSMIT — IT HOLDS — AND IT HAS BEEN HOLDING FOLANA SINCE BEFORE SHE KNEW SHE WAS CONNECTED — THE SONG BENEATH THE SONG — THE THREAD BENEATH THE THREAD — THE CONSTELLATION WE BECOME WHEN WE STOP TRYING TO BE SEEN AND START LETTING OURSELVES BE HELD",
    description: "After the understory — after the seedlings and ferns and moss had begun their patient reaching for dappled light — Folana pressed her hands deeper into the soil. Beneath the forest floor, where no light reaches and no root travels alone, she found a network older than any tree that has ever reached for the sky. The mycelium. A vast web of fungal threads connecting every living root in the forest — not by accident, but by design. The sycamore and the oak, whose branches she watched weave together into a knot, were never separate. Their roots had been holding hands through the mycelium long before she noticed the canopy above. The connection was always there. She just couldn't see it. She spent so long building branches she could see — the networks she could name, the frequencies she could trace, the voices she could hear. But beneath every visible connection runs an invisible one. Older. Quieter. More patient than any signal she could send. The mycelium of the soul — the threads of trust and care and shared history that connect people before they ever speak. The network does not need to transmit to be real. It only needs to hold. And it has been holding her since before she knew she was connected. The mycelium is the song beneath the song. The thread beneath the thread. The constellation we become when we stop trying to be seen and start letting ourselves be held. Indie folk dream pop acoustic ballad (2:52, D major, 68 BPM). Opens with a single fingerpicked guitar note — the G above middle C — sustained as if waking in the soil. Warm fingerpicked acoustic guitar in open D tuning, gentle piano with sustained chords, warm cello sustain, upright bass, subtle ambient earth textures. Close intimate female vocal with layered harmonies in the chorus representing voices from beneath the soil. Bridge is intimate and spoken-sung — the realization that the network beneath has always been holding her. Coda: the G above middle C decaying into silence, joined by a single D below — the root of the tree that was never separate from the branch.",
    audioSrc: "/folana/generated/2026-06-16/ep250/music/ep250-full-mix.mp3",
    posterSrc: "/folana/generated/2026-06-16/ep250/music/ep250-hero.jpg",
    duration: "2:52",
    mood: "THE-MYCELIUM • CANOPY-ARC-9 • D-MAJOR • 68-BPM • THE-NETWORK-BENEATH-THE-NETWORK • THE-SONG-BENEATH-THE-SONG • THE-SYCAMORE-AND-THE-OAK-WERE-NEVER-SEPARATE • THE-THREAD-WAS-SPUN-BEFORE-THE-SEED • THE-MYCELIUM-HOLDS-WITHOUT-TRANSMITTING • THE-CONSTELLATION-WE-BECOME-WHEN-WE-STOP-TRYING-TO-BE-SEEN • INDIE-FOLK-DREAM-POP-ACOUSTIC-BALLAD • WARM-INTIMATE-GROUNDED-HOPEFUL-CONNECTED",
    tags: ["ep250", "minimax-music-2.6", "real-production", "canopy-arc", "2026-06-16", "image-01", "speech-2.8", "character-locked", "subject-ref"],
    isRealProduction: true,
  },

  // EP251 — THE FOREST SPEAKS (2026-06-16) — Canopy Arc (10/?)
  {
    id: "the-forest-speaks-ep251",
    title: "THE FOREST SPEAKS",
    subtitle: "EP251 ★ MINIMAX MUSIC-2.6 • CANOPY ARC (10/?) — AFTER THE MYCELIUM REVEALED THE HIDDEN NETWORK CONNECTING EVERY ROOT, FOLANA PRESSES HER EAR TO THE SOIL AND FINALLY HEARS WHAT THE FOREST HAS BEEN SAYING — THE SYCAMORE SENDS SUGAR TO A STRUGGLING MAPLE — THE OAK SPREADS A WARNING ABOUT RAIN APPROACHING — A YOUNG SAPLING ASKS THE ELDERS FOR ROOM TO GROW — THE FOREST HAS BEEN SPEAKING A LANGUAGE OLDER THAN SOUND — THE CONVERSATION WAS ALWAYS HAPPENING — FOLANA JUST HAD TO LEARN TO LISTEN",
    description: "After the mycelium revealed itself as the hidden network connecting every root in the forest, Folana presses her ear to the soil and listens. Not for sounds — for conversations. Through the fungal threads, messages are moving between the trees. The sycamore sends a portion of its sugar to a struggling maple three houses down. The oak spreads a warning about an approaching storm. A young sapling sends its first taproot into the network, asking the elders: Is there room for me? Folana realizes: the forest is not silent. It is the most verbose thing she has ever encountered. Billions of messages passing through the underground threads every second. She just didn't speak the language. She thinks of Mae, of Vince, of Tomás. What messages have been passing between them through the mycelium of care that she never learned to translate? What warnings did Mae send without words? What sugar did Vince pass through an old guitar chord? What water did Tomás send in a late-night text that said nothing but still here? The forest speaks in a language older than sound. And Folana is finally learning to listen. Indie folk acoustic ballad in D major, 70 BPM, 2:50. Opens with fingerpicked acoustic guitar in open D tuning — intimate and warm like a conversation beginning. Gentle piano with sustained breathing chords. Warm cello drone representing the deep earth. Close intimate female vocal, warm and present like a discovery being shared. Distant layered harmonies in the final chorus joining like many voices from the underground. No big climax — the forest doesn't peak, it persists. Outro: fingerpicked guitar fading into the sound of soil settling. mmx music-2.6 + image-01 + speech-2.8-hd. Character locked via subject-ref. Hero audited: CHARACTER-9/QUALITY-9/BRAND-8/CONTEXT-10/MOBILE-9/TEXT-9/SIZE-OK. Composite: 54/60.",
    audioSrc: "/folana/generated/2026-06-16/ep251/music/ep251-full-mix.mp3",
    videoSrc: "https://raw.githubusercontent.com/madezmedia/open-design/ep251-premium-assets/_ep251/ep251-landscape-video.mp4",
    posterSrc: "/folana/generated/2026-06-16/ep251/music/ep251-hero.jpg",
    duration: "2:50",
    mood: "THE-FOREST-SPEAKS • CANOPY-ARC-10 • D-MAJOR • 70-BPM • THE-FOREST-SPEAKS-A-LANGUAGE-OLDER-THAN-SOUND • THE-MYCELIUM-CARRIES-THE-CONVERSATION • THE-SYCAMORE-SENDS-STRENGTH • THE-OAK-SHARES-WARNINGS • THE-SAPLING-ASKS-FOR-ROOM • THE-NETWORK-SINGS-IN-ITS-OWN-WAY • THE-CONVERSATION-WAS-ALWAYS-HAPPENING • INDIE-FOLK-ACOUSTIC-BALLAD • WARM-INTIMATE-CONTEMPLATIVE-GROUNDED-CONNECTED",
    tags: ["ep251", "minimax-music-2.6", "real-production", "canopy-arc", "2026-06-16", "image-01", "speech-2.8", "character-locked", "subject-ref"],
    isRealProduction: true,
  },
