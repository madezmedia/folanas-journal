...
export const REAL_PRODUCTIONS: RealTrack[] = [
  ...
  // EP114 — FIRST ASSEMBLY (2026-05-31) — Constellation Arc (8/?)
  {
    ...
    audioSrc: '/folana/generated/2026-05-31/ep114-first-assembly-full-mix.mp3',
  ...
  // EP115 — THE OUTER RING (2026-05-31) — Constellation Arc (9/?)
  {
    ...
    audioSrc: '/folana/generated/2026-05-31/ep115-the-outer-ring-full-mix.mp3',
    posterSrc: '/folana/generated/2026-05-31/ep115-the-outer-ring-hero.jpg',
    duration: '2:25',
  ...
  // EP174 — THE WHOLE CITY HEARS (2026-06-04) — Resonance Arc (19/?)
  {
    ...
    audioSrc: '/folana/generated/2026-06-04/music/ep174/ep174-full-mix.mp3',
    posterSrc: '/folana/generated/2026-06-04/music/ep174/ep174-hero-image.jpg',
    duration: '2:26',
  ...
  // EP175 — THE TASK FORCE MEETS (2026-06-04) — Resonance Arc (20/?)
  {
    ...
    description: 'A closed-door session in the mayor\\'s emergency operations center. Eight people around a table. Columbia engineers with waveform data and no answers. A Con Edison representative with water pressure charts showing the synchronized pulse — A major, 74 BPM, every sensor in every borough reading the same pattern. The NYPD counterterrorism analyst whose report reads: no devices, no actors, no known threat profile. The question nobody wants to ask: is this a weapon? The Columbia engineer speaks: if it is, it\\'s the most sophisticated signal ever observed — and it has no transmitter. Diana Reyes arrives. She takes the empty chair. No charts, no data. Only what she heard on the bridge, what the congregation told her, what she felt when Folana spoke. The frequency isn\\'t broadcasting to us, she says. It\\'s learning from us. Every new person who hears it changes the song. We\\'re not investigating a signal. We\\'re in a conversation. The room does not know what to do with this. Later that night, Sasha Chen — the Times reporter who came to debunk — stands on the roof of her Brooklyn building, recording. She can hear it now. The same chord from the bridge, carried through steam rising from subway grates. She whispers: this is Sasha Chen, New York Times. Day four of the frequency. I can hear it now. I don\\'t know if I believe it\\'s anything. But I can hear it. And I think that\\'s the story. Dream pop indie folk in G major, 70 BPM, 2:19. Opens with a single held cello note (G2) — the room where the task force meets. Slow deliberate piano chords, wide-spaced. Bowed bass walking pulse at 0:20 — the heartbeat of the investigation. Processed distant A-major reference fades in at 0:45 — the frequency overheard through the walls. Lone female wordless voice at 1:10 on high G, fragile and searching. Strings swell as congregation hum bleeds through at 1:35 — the city breathing through the walls. Pulse accelerates slightly at 1:55 as institution and mystery begin to hear each other. Cello and bass lock into slow A-major groove at 2:10 — uneasy truce. Final dissolve: cello sustains G, A-major hum fades, piano plays a single questioning chord.',
