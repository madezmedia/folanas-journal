  ...
  try {
    ...
    if (data) {
      ...
      return {
        ...
        reach_label: asMaybeString(row.reach_label),
        influence_label: asMaybeString(row.influence_label),
        synthetic_resonance: asMaybeNumber(row.synthetic_resonance),
        holographic_engagement: asMaybeNumber(row.holographic_engagement),
