...
export default async function FolanasJournal() {
  ...
  return (
    <>
      ...
      <div className="sticky top-[79px] z-40 border-b border-white/10 bg-folana-surface/60 backdrop-blur-xl">
        <div className="mx-auto flex max-w-[1480px] flex-wrap items-center gap-x-4 gap-y-2 px-4 py-4 text-sm sm:px-6">
          ...
          <div className="font-mono text-[10px] tracking-widest text-folana-neon-cyan sm:text-xs">{signals.handle}</div>
        </div>
      </div>

      <main className="mx-auto max-w-[1480px] space-y-16 px-4 pt-10 pb-24 sm:space-y-24 sm:px-6 sm:pt-16">
        {featured && (
          <ReleaseHubSurface
            featured={featured}
        ...
        <section id="echo">
          <div className="mb-9 flex items-end justify-between border-b border-white/10 pb-5">
            <div>
              ...
              <h2 className="font-serif text-3xl tracking-tight sm:text-5xl md:text-6xl md:tracking-[-2.6px]">Latest entries</h2>
            </div>
